...
namespace OOAP_Lab1
{
    public partial class ProdSystemForm : Form
    {
        ...
        private List<ProdFactory> factories;
        UC_Create uc_create;
        public ProdSystemForm()
        {
            ...
            factories = new List<ProdFactory>() 
            {
                new MotherboardProdFactory(),
                new ProcessProdFactory(),
                new HardDriveProdFactory()
            };
        }
        ...
        {
            factories[0].addInputs(panel_Button, uc_create);
            currentProduct = factories[0].createProd();
        }

        private void createProcessor(object sender, EventArgs e)
        {
            factories[1].addInputs(panel_Button, uc_create);
            currentProduct = factories[1].createProd();
        }

        private void createHardDrive(object sender, EventArgs e)
        {
            factories[2].addInputs(panel_Button, uc_create);
            currentProduct = factories[2].createProd();
        }
...
class Motherboard : Product
{
    ...
    public override string getStringKey() => "Motherboard";
}
...
class Processor : Product
{
    ...
    public override string getStringKey() => "Processor";
}
...
class HardDrive : Product
{
    ...
    public override string getStringKey() => "HardDrive";
}

abstract class ProdFactory
{
    public abstract void addInputs(Panel panel, UserControl uc);
    public abstract Product createProd();

}

class MotherboardProdFactory : ProdFactory
{
    public override void addInputs(Panel panel, UserControl uc)
    {
        panel.Height = 41;
        Panel panel_fac = uc.Controls.Find("factory_panel", true).FirstOrDefault() as Panel;
        ...
        panel_fac.Controls.Add(label_socket_type);
        panel_fac.Controls.Add(textbox_socket_type);
        panel_fac.Controls.Add(label_num_of_proc);
        panel_fac.Controls.Add(textbox_num_of_proc);
        panel_fac.Controls.Add(label_ram_type);
        panel_fac.Controls.Add(textbox_ram_type);
        panel_fac.Controls.Add(label_system_bus_frec);
        panel_fac.Controls.Add(textbox_system_bus_frec);
    }

    public override Product createProd() 
    {
        return new Motherboard();
    }
}

class ProcessProdFactory : ProdFactory
{
    public override void addInputs(Panel panel, UserControl uc)
    {
        panel.Height = 41;
        ...
        panel_fac.Controls.Add(label_socket_type);
        panel_fac.Controls.Add(textbox_socket_type);
        panel_fac.Controls.Add(label_num_of_cores);
        panel_fac.Controls.Add(textbox_num_of_cores);
        panel_fac.Controls.Add(label_clock_speed);
        panel_fac.Controls.Add(textbox_clock_speed);
        panel_fac.Controls.Add(label_tech_process);
        panel_fac.Controls.Add(textbox_tech_process);
    }
...
class HardDriveProdFactory : ProdFactory
{
    public override void addInputs(Panel panel, UserControl uc)
    {
        panel.Height = 41;
        ...
        panel_fac.Controls.Add(label_volume);
        panel_fac.Controls.Add(textbox_volume);
        panel_fac.Controls.Add(label_rpm);
        panel_fac.Controls.Add(textbox_rpm);
        panel_fac.Controls.Add(label_type_interface);
        panel_fac.Controls.Add(textbox_interface);
    }
